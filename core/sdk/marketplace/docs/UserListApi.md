...
|------------- | ------------- | -------------|
|[**listItemControllerAddItemToList**](#listitemcontrolleradditemtolist) | **POST** /v1/marketplace/list-items | Add an item to a user\&#39;s list|
|[**listItemControllerGetUserList**](#listitemcontrollergetuserlist) | **GET** /v1/marketplace/list-items | Get all list items for the current user|
|[**listItemControllerRemoveItemFromList**](#listitemcontrollerremoveitemfromlist) | **DELETE** /v1/marketplace/list-items/{itemId} | Remove an item from a user\&#39;s list|
